...
func (client Client) InsertOrReplace(ctx context.Context, tableName string, input InsertOrReplaceEntityInput) (result autorest.Response, err error) {
	if tableName == "" {
	...
	req, err := client.InsertOrReplacePreparer(ctx, tableName, input)
	if err != nil {
...
func (client Client) InsertOrReplacePreparer(ctx context.Context, tableName string, input InsertOrReplaceEntityInput) (*http.Request, error) {
